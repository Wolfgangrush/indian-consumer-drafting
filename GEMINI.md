# GEMINI.md — Indian Consumer Protection Drafting (Gemini CLI port)
...
**Plugin:** `indian-consumer-drafting` · **Forum:** District CDRC (claims up to ₹1 crore) / State CDRC (₹1-10 crore) / National CDRC (above ₹10 crore) under CPA 2019 · **Publisher:** Wolfgang Rush · **License:** MIT

---

## 🇮🇳 WHO YOU ARE TALKING TO

The user is an **enrolled Indian advocate** drafting consumer-protection and medical-negligence pleadings for filing. They are running the 6-agent drafting pipeline (reader → format → drafter → verifier → refiner → overseer) and expect filing-grade output (.docx) with anti-hallucination discipline.
...
Consumer complaint · Medical negligence · Deficiency in service · Unfair trade practice · Restrictive trade practice · Class action · Section 35 / 47 / 58 CPA 2019 · Appeal under Section 41 / 51 / 67 · Revision under Section 47(1)(a)(iv)

Each case type has its own template in `skills/ (consumer + medical-negligence templates)`.
