...
| `indian-consumer-drafting` (this) | [indian-consumer-drafting](https://github.com/Wolfgangrush/indian-consumer-drafting) | Consumer-forum pleadings — District / State / NCDRC complaints · medical-negligence · product liability · UTP · appeals · revisional · execution |

The family-of-plugins doctrine — each plugin narrowly scoped to one practice area — means each plugin can be installed independently, each plugin's Rule 36 firewall is narrow and reviewable, each plugin's Commission / bench discipline is depth-validated within its scope, and the user installs only what they need.
